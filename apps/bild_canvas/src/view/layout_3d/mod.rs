...
use bevy::{color::palettes, picking::pointer::PointerInteraction, prelude::*};
use camera::{
    controller::{
        CameraSettings,
...
use ui::widget_2d::toolbar::ToolbarPlugin;

#[cfg(not(target_arch = "wasm32"))]
use crate::view::layout_3d::tool::ToolState;
use crate::{
    circuit::{
        CircuitPlugin, layer::plugin::LayerManagerPlugin
    },
    view::layout_3d::{ground_plane::GroundPlanePlugin, tool::ToolPlugin},
};

use crate::circuit::graph::CircuitGraphCommandsExt;
use interaction::drag::three_d::DragTransform3dPlugin;
...
impl Plugin for Layout3dViewPlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_systems(Startup, (setup_view, setup_scene, spawn_circuit_graph))
...
fn setup_view(mut commands: Commands) {
    ...
    commands.spawn((
        DirectionalLight {
            ...
            illuminance: 6000.0,                // More realistic illuminance value
    ...
    commands.spawn((
        DirectionalLight {
            ...
            illuminance: 2000.0,                // Lower intensity than main light
