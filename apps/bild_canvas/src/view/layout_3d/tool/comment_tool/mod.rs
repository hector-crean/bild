...
use bevy::prelude::*;
use ui::widget_2d::comment::{CommentUi, CommentUiPlugin};
use ui::widget_3d::worldspace_ui_node::{WorldspaceUiNode, WorldspaceUiNodePlugin};
...
impl CommentToolPlugin {
    fn handle_placing(
        ...
        mut pointer_events: MessageReader<Pointer<Click>>,
