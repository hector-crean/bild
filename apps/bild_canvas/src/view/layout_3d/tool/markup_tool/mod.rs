...
use ui::widget_3d::radial_menu::{OpenRadialMenu, RadialItemData, RadialMenuPosition};
...
impl MarkupToolPlugin {
    fn handle_state_transition(
        mut state_reader: MessageReader<StateTransitionEvent<MarkupToolState>>,
    ) {
    ...
    fn open_radial_menu(mut radial_menu_rdr: MessageWriter<OpenRadialMenu>) {
