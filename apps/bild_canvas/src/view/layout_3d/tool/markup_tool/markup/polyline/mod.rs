...
use interaction::picking::double_click::DoubleClick;
use std::time::Duration;
use geometry::representation::polyline::prelude::*;

use crate::view::layout_3d::tool::markup_tool::MarkupToolState;
...
impl PolylineMarkupPlugin {
    ...
    fn debug_state_transition(
        mut state_reader: MessageReader<StateTransitionEvent<PolylineMarkupState>>,
    ) {
    ...
    fn start_draft_on_first_click(
        ...
        mut pointer_click_events: MessageReader<Pointer<Click>>,
    ...
    fn finish_draft_on_double_click(
        double_click_events: MessageReader<Pointer<DoubleClick>>,
        mut polyline_query: Query<&mut PolylineState>,
        mut next_state: ResMut<NextState<PolylineMarkupState>>,
    ) {
