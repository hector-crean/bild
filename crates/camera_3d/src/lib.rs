...
//! app.add_plugins(camera_3d::DefaultEditorCamPlugins);
//! ```
//!
...
/// Adds [`camera_3d`](crate) functionality with all extensions and the default input plugin.
