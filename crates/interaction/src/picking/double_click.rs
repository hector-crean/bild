...
impl Plugin for DoubleClickPlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_message::<Pointer<DoubleClick>>()
...
impl DoubleClickPlugin {
    fn double_click(
        ...
        time: Res<Time>,
        mut double_click_writer: MessageWriter<Pointer<DoubleClick>>,
    ) {
        for click in click_reader.read() {
            ...
            if click_delta < threshold {
                ...
                double_click_writer.write(Pointer::<DoubleClick>::new(click.pointer_id, click.pointer_location.clone(), event, click.entity));
            }
